...
ORDER = ['net',
         ...
         'threads', 'thread_cache_misses', 'volume_io',
...
CHARTS = {
    ...
    'threads': {
        ...
        'lines': [
            ...
            ['Max_used_connections', 'maxusedcon', 'absolute']
        ]},
    'thread_cache_misses': {
    ...
    'volume_io': {
        ...
        'lines': [
            ...
            ['Com_insert_select', 'insert_select', 'incremental'],
            ['Com_update_multi', 'update_multi', 'incremental'],
            ['Com_delete_multi', 'delete_multi', 'incremental'],
            ['Com_replace_select', 'replace_select', 'incremental'],
            ['Qcache_hits', 'qcache_hit', 'incremental']
        ]},
    'innodb_io': {
